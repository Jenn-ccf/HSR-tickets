...
if CHATBOT_MODE:
    try:
        responseDICT = json.load(open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "reply/reply_seat.json"), encoding="utf-8"))
    except Exception as e:
...
def debugInfo(inputSTR, utterance):
    if DEBUG:
        print("[seat] {} ===> {}".format(inputSTR, utterance))
